    ...
    <>
      ...
      <header className="observatory-rail">
        <a className="observatory-mark" href="#top" aria-label="Mamba Hybrid LM home">
          <img src={`${import.meta.env.BASE_URL}assets/hybrid-observatory-glyph.svg`} alt="" />
          <span>HYB<br />02</span>
        </a>
      ...
      <main id="main" className="observatory-main">
        ...
        <section className="closing-section">
          <div className="closing-emblem" aria-hidden="true"><img src={`${import.meta.env.BASE_URL}assets/hybrid-observatory-glyph.svg`} alt="" /></div>
